...
In this series of [three] talks (borrowing from a talk jointly written with Nuiok Dicaire) we'll:

- Explore how type theories for certain cartesian monoidal (higher)-categories, HoTT for example, through their term calculus can:
...
- Treat the example of the free dual pair in this type theory in some detail, explaining: **) how a natural presentation of the free dual pair as a co-equalizer of free (coloured)-Props defines a PTT
